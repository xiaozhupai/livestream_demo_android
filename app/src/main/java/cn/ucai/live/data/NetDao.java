...
public class NetDao {
    ...
    public static void createLive(Context context, User user, OkHttpUtils.OnCompleteListener<String> listener){
        OkHttpUtils<String> utils=new OkHttpUtils<>(context);
        utils.setRequestUrl(I.REQUEST_CREATE_GROUP)
                .addParam("auth","1IFgE")
    ...
    public static void removeLive(Context context, String chatroomId, OkHttpUtils.OnCompleteListener<String> listener){
        OkHttpUtils<String> utils=new OkHttpUtils<>(context);
    ...
    public static void loadAllGift(Context context,  OkHttpUtils.OnCompleteListener<String> listener){
        OkHttpUtils<String> utils=new OkHttpUtils<>(context);
    ...
    public static void giveGift(Context context,String username,String anchor,int giftId,int count,
                                OkHttpUtils.OnCompleteListener<String> listener){
        OkHttpUtils<String> utils=new OkHttpUtils<>(context);
        utils.setRequestUrl(I.REQUEST_GIVING_GIFT)
                .addParam("uname",username)
